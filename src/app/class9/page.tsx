...
export default function Class9Landing() {
  ...
  const subjects = [
    {
      ...
      description:
        "Learn about motion, force, energy, sound, and light through interactive lessons.",
      chapters: 8,
    ...
    },
    {
      ...
      description:
        "Discover atoms, elements, chemical reactions, and the periodic table.",
      chapters: 7,
      image: "/api/placeholder/400/300",
    },
    {
      ...
      description:
        "Explore cells, human body systems, plants, and our natural environment.",
      chapters: 9,
      image: "/api/placeholder/400/300",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-400 mt-2 text-lg max-w-2xl">
            Begin your journey into science with foundational concepts. Choose a
            subject below to start learning.
          </p>
        </motion.div>
        ...
        >
          <h2 className="text-2xl font-bold mb-6 flex items-center">
            ...
            <div className="h-1 flex-grow bg-gradient-to-r from-emerald-500 to-transparent rounded-full ml-4"></div>
          </h2>
