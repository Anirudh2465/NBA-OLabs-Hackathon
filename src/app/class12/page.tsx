...
export default function Class12Landing() {
  ...
  // Handle navigation to subject page
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-400 mt-2 text-lg max-w-2xl">
            Master advanced scientific concepts to prepare for higher education
            and competitive exams. Select a subject below to begin your advanced
            studies.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="bg-gray-800 rounded-xl p-6">
            <p className="text-gray-300 mb-4">
              Key topics for competitive exams and college preparation:
            </p>
