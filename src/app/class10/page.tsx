...
export default function Class10Landing() {
  ...
  const subjects = [
    {
      ...
      description:
        "Study electricity, magnetism, optics, and the fundamental laws of motion.",
      chapters: 10,
    ...
    },
    {
      ...
      description:
        "Explore chemical reactions, acids and bases, metals and non-metals.",
      chapters: 11,
      image: "/api/placeholder/400/300",
    },
    {
      ...
      description:
        "Learn about life processes, control and coordination, reproduction, and heredity.",
      chapters: 9,
      image: "/api/placeholder/400/300",
    },
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-purple-600">
            Class 10
          </h1>
          <p className="text-gray-400 mt-2 text-lg max-w-2xl">
            Deepen your understanding of science with intermediate concepts.
        ...
        >
          <h2 className="text-2xl font-bold mb-6 flex items-center">
            ...
            <div className="h-1 flex-grow bg-gradient-to-r from-violet-500 to-transparent rounded-full ml-4"></div>
          </h2>

          <div className="bg-gray-800 rounded-xl p-6">
            <p className="text-gray-300 mb-4">
              Try these important topics for your exams:
            </p>
