...
const ExperimentForm = ({ setExperiment }) => {
  ...
  // Replace the handleSubmit function in ExperimentForm.jsx with this:
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push(`/simulator/generated_projects/${folderName}`);
    } catch (err) {
    ...
    <div className="experiment-form-container">
      <div className="form-wrapper">
        ...
        <p className="form-description">
          Enter details about a experiment you want to simulate, and our AI will
          generate a complete interactive web application for you.
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="experiment_description">
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Describe the  experiment in detail..."
              rows="6"
              required
            />
          </div>
        ...
        <div className="experiment-examples">
          ...
          <ul>
            <li>
              Electrolysis of water with visualization of H₂ and O₂ production
            </li>
            <li>Acid-base titration with pH indicator color changes</li>
            <li>
              Chemical equilibrium simulation with Le Chatelier's principle
            </li>
